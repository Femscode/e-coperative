    ...
    <div class="container mt-4">
        ...
        <div class="loan-nav-wrapper mb-4">
            <div class="row g-2">
                ...
                <div class="col-6">
                    <a href="/member/loan/ongoing" class="nav-link text-center py-3 active2 h-100">
                        <div class="d-flex align-items-center justify-content-center">
                ...
                <div class="col-6">
                    <a href="/member/loan/completed" class="nav-link text-center py-3 h-100  {{ request()->is('member/loan-repayment/completed*') ? 'active' : '' }}">
                        <div class="d-flex align-items-center justify-content-center">
                    ...
                    <div class="card-body p-4">
                        <div class="table-responsive">
                            ...
                            <table class="table table-hover align-middle">
                                <thead class="table-light">
                                    <tr>
                                        ...
                                        <th class="text-end">Monthly Refund</th>
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td class="text-end">₦{{ number_format($transaction->monthly_return, 2) }}</td>
                            ...
                            <div class="text-center py-5">
                                ...
                                <h5>No Ongoing Loans</h5>
                                <p class="text-muted">There are no ongoing loans at the moment.</p>
                            </div>
                            @endif
                        </div>
