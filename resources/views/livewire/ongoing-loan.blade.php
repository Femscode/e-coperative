                    ...
                    <div id="customerList">
                        @if($loans->count() > 0)
                            <div class="transaction-list">
                                ...
                                <div class="transaction-item" data-type="Loan" data-status="ongoing">
                                    <div class="t-icon">
                                    ...
                                    <div class="t-info">
                                        ...
                                        <div class="t-type">
                                            Monthly Return: ₦{{ number_format($transaction->monthly_return, 2) }}
                                            <span class="ms-2 text-muted">|</span>
                                            <span class="ms-2">Refund: ₦{{ number_format($transaction->total_refund, 2) }}</span>
                                        </div>
                                    </div>
                                    <div class="t-details">
                                        <div class="t-date">{{ $transaction->applied_date }}</div>
                                        <div class="t-balance text-muted">Balance: ₦{{ number_format($transaction->total_left, 2) }}</div>
                                    </div>
                                    <div class="t-amount" data-status="ongoing">
