                                    ...
                                    <tbody class="list form-check-all">
                                        ...
                                        <tr>
                                            ...
                                            <td class="text-muted">
                                                ...
                                                <button class="btn rounded-pill btn-sm btn-soft-info" onclick="processPayment(this)" data-amount="{{auth()->user()->plan()->loan_form_amount  }}" data-id="{{ $transaction->uuid }}">Pay</button>
                                                @endif
