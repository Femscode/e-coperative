...
<!-- <div class="main-banner-area overflow-hidden position-relative" style="background-image: url(frontend_assets/images/colorful-bg.jpg)"> -->
<div class="main-banner-area overflow-hidden position-relative" style="background-image: url(frontend_assets/images/colorful-bg.jp); background-color: rgba(255, 255, 255, 0.75); background-blend-mode: overlay;">
        ...
        <div class="row align-items-center">
            <div class="col-xl-5 col-lg-12" data-cues="slideInRight" data-duration="800">
                <div class="main-banner-content">
                    <h1 class="mb-2">Your <span><img src="frontend_assets/images/svg/your.svg" alt="image"> Cooperative</span> Now at Your Fingertips.</h1>
                    <p>Digitize your savings, loans, and membership management with a seamless, scalable platform designed for cooperatives and Ajo groups.</p>
                </div>
            </div>
            <div class="col-xl-7 col-lg-12" data-cues="slideInLeft" data-duration="800">
                <div class="info">
                    <img src="{{ asset('frontend_assets/images/moneygrow.jpg') }}"/>
                </div>
            </div>
        </div>
    </div>
    <div class="card-area">
        <div class="container-fluid side-padding">
            <div class="row g-4 justify-content-center" data-cues="slideInUp" data-duration="800">
                <div class="col-xl-4 col-lg-6 col-md-6">
                    <div class="banner-card bg-color-ffffff radius-30">
                        ...
                        <div class="banner-card-body bg-color-def1ee">
                            <img src="frontend_assets/images/registration.jpg" alt="image">
                        </div>
                    </div>
                ...
                <div class="col-xl-4 col-lg-6 col-md-6">
                    <div class="banner-card part-two bg-color-FF821A radius-30 position-relative">
                        <div class="flex-warp position-relative">
                            <i>
                        ...
                        <div class="banner-card-image">
                            <div class="text-end">
                                <img src="frontend_assets/images/ibadan.jpg" alt="image">
                            </div>
                        </div>
                ...
                <div class="col-xl-4 col-lg-6 col-md-6">
                    <div class="banner-card part-two bg-color-ffffff radius-30 position-relative">
                        <div class="flex-warp position-relative">
                            ...
                            <p class='mb-0'>Track savings, process loans, and handle payments seamlessly</p>
                        </div>
                        <div class="banner-card-image">
                            <div class="text-end">
                                <img class="service-image-3" src="frontend_assets/images/chart.jpg" alt="image">
                            </div>
                        </div>
    ...
    <div class="container">
        <div class="row align-items-center">
            <div class="col-xl-6 col-lg-12" data-cues="slideInRight" data-duration="800">
                <div class="features-image bg-color-FF821A radius-30 position-relative">
                    <!-- <img class="feature-image-1" src="frontend_assets/images/feature/feature-image-1.png" alt="image"> -->
                    <img class="feature-image-2 bounce" src="frontend_assets/images/hausa.jpg" alt="image">
                ...
                <div class="features-content">
                    ...
                    <ul>
                        <li class="bg-color-29594b radius-20">
                            ...
                            <h3 class="text-dark">Streamlined Member Management</h3>
                            <p class="text-dark">Easily add, track, and engage with members through a user-friendly dashboard, ensuring everyone stays connected and informed.</p>
                        </li>
                        <li class="bg-color-29594b radius-20">
                            <i class="flaticon-payment-method"></i>
                            <h3 class="text-dark">Secure Payment Processing</h3>
                            <p class="text-dark">Simplify transactions with robust payment solutions that allow members to make deposits, pay dues, and apply for loans with confidence.</p>
                        </li>
                        <li class="bg-color-29594b radius-20">
                            <i class="flaticon-laptop-2"></i>
                            <h3 class="text-dark">Loan Management System</h3>
                            <p class="text-dark">Offer transparent and efficient loan applications, approvals, and repayments, helping your members access funds when they need them most.</p>
                        </li>
                    </ul>
                </div>
            </div>
                        ...
                        <div class="swiper-wrapper">
                            ...
                            <div class="swiper-slide">
                                <div class="services-card position-relative">
                                    <img class="radius-30" src="frontend_assets/images/ibadan.jpg" alt="image">
                                    <div style='opacity:0.7 !important' class="services-card-body bg-color-fffaeb radius-30">
                                        <i class="flaticon-businessman-5 businessman"></i>
                                        <h3>
                                            <a style='color:green' href="service-details.html">{{$company->name}}</a>
                                        </h3>

                                        <h4 class="mb-0">{{ $company->description }}.</h4>
                                        <a href="/signup/{{$company->slug}}" class="read-more">Join Now <i class="ri-arrow-right-up-line"></i></a>
                                    </div>
                                </div>
                            </div>
                            @endforeach
        ...
        <div class="container">
            ...
            <div class="row" data-cues="slideInUp" data-duration="800">
                <div class="col-lg-6 col-md-12">
                    <div class="testimonials-image bg-color-FF821A radius-30 position-relative">
...
<div class="faq-area pb-120 overflow-hidden">
    <div class="container">
        <div class="row g-4 align-items-center">
            <div class="col-lg-6 col-md-12" data-cues="slideInRight" data-duration="800">
                <div class="question-card bg-color-FF821A radius-30">
                    <div class="section-heading">
                    ...
                    <img class="radius-30" src="frontend_assets/images/counting_money.jpg" alt="image">
                </div>
            </div>
            <div class="col-lg-6 col-md-12" data-cues="slideInLeft" data-duration="800">
                        ...
                        <div class="accordion-item">
                            ...
                            <div id="collapseBang" class="accordion-collapse collapse show" data-bs-parent="#accordionFAQ">
                                <div class="accordion-body">
                                    <p>Syncosave is a digital platform that enables local cooperatives to manage their operations, finances, and member interactions online.</p>
                                </div>
                            </div>
                        </div>
                        <div class="accordion-item">
