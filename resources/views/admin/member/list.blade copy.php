    ...
    <div class="col-lg-12">
        <div class="card">
            <div class="card-header d-flex">
                <h4 class="card-title mb-0">Manage Members</h4>
                <button type="button" class="btn btn-success add-btn ms-auto" data-bs-toggle="modal" id="create-btn" data-bs-target="#showModal"> Import</button>
            </div><!-- end card header -->
                ...
                <div id="customerList">
                    <div class="row g-4 mb-3">
                        <div class="col-sm-auto">
                            <div>
                                <button type="button" class="btn btn-success add-btn" data-bs-toggle="modal" id="create-btn" data-bs-target="#showModals"><i class="ri-add-line align-bottom me-1"></i> Add User</button>
                            </div>
                        </div>
                        <div class="col-sm">
                                        ...
                                        <td>
                                            <div class="d-flex gap-2">
                                                <div class="edit">
                                                    ...
                                                    data-id="{{ $member->id }}" data-bs-toggle="modal" data-bs-target="#editModal">Edit</button>
                                                </div>
                                                <div class="remove">
                                                    <button class="btn btn-sm btn-danger remove-item-btn" data-id="{{ $member->id }}" id="deleteRecord">Remove</button>
                                                </div>
                                            </div>
                                        </td>
...
<div class="modal fade" id="showModal" tabindex="-1" aria-labelledby="exampleModalLabel"
    ...
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content">
            ...
            <form method="Post" action="" id="importMemberForm">
                @csrf
                <div class="modal-body">
