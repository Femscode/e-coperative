...
<div class="container-fluid">
    ...
    <div class="position-relative mx-n4 mt-n4">
        <div class="profile-wid-bg profile-setting-img">
            <img @if($user->cover_image) src="{{ asset("$user->cover_image") }}" @else src="{{ asset('assets/images/profile-bg.jpg') }}" @endif class="profile-wid-img" alt="">  
                ...
                <div class="card-body p-4">
                    <div class="text-center">
                        <div class="profile-user position-relative d-inline-block mx-auto  mb-4">
                            <img @if($user->profile_image) src="{{ asset("$user->profile_image") }}" @else src="{{ asset('assets/images/avatar.png') }}" @endif class="rounded-circle avatar-xl img-thumbnail user-profile-image" alt="user-profile-image">
                                ...
                                <div class="row">
                                    <div class="col-lg-6">
                                        <div class="mb-3">
                                            ...
                                            <input type="text" class="form-control" id="firstnameInput" placeholder="Enter your firstname" value="{{ current(explode(' ', $user->name)) }}">
                                        </div>
                                    </div><!--end col-->
                                    <div class="col-lg-6">
                                        <div class="mb-3">
                                            <label for="lastnameInput" class="form-label">Last Name</label>
                                            <input type="text" class="form-control" id="lastnameInput" placeholder="Enter your lastname" value="{{ last(explode(' ', $user->name)) }}">
                                        </div>
                                    </div><!--end col-->
                                    <div class="col-lg-6">
                                        <div class="mb-3">
