    ...
    <div class="col-12 mb-4">
        <div class="nav-tabs-custom">
            <div class="row g-2">
                ...
                <div class="col-6">
                    <a href="/admin/application/awaiting-disbursement" class="nav-link text-center py-3 active">
                        <div class="d-flex align-items-center justify-content-center">
                ...
                <div class="col-6">
                    <a href="/admin/application/completed" class="nav-link text-center py-3">
                        <div class="d-flex align-items-center justify-content-center">
