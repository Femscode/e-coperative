                                    ...
                                    <div class="row g-2">
                                        ...
                                        <div class="col-lg-4">
                                            <div>
                                                ...
                                                <input class="form-control rounded-pill mb-3" value="{{ $user->account_number }}" type="text" class="form-control" pattern="^\d{10}$" required name="account_number" id="accountNumberInput" placeholder="Account number">
                                            </div>
                                        </div>
                                        <div class="col-lg-4" @if(!$user->account_name) style="display:none" @endif id="accountDiv">
                                            <div>
                                                ...
                                                <input type="text" readonly class="form-control rounded-pill mb-3" value="{{ $user->account_name }}" id="accountName" name="account_name" placeholder="account name">
                                            </div>
                                        </div><!--end col--><!--end col-->
                                        {{-- <div class="col-lg-12">
                                        <div class="mb-3">
        ...
        $("#verifyAccount").on('submit', async function(e) {
            ...
            try {
                ...
                if (response.status === 'ok') {
                    ...
                    $("#account_name").html(response.data)
                } else {
                    throw new Error(response.message);
                }
            } catch (error) {
