        ...
        <div class="col-lg-12">
            <div class="card">
                <div class="card-header align-items-center d-flex">
                    <h4 class="card-title mb-0 flex-grow-1">Available Weekly Dues</h4>
                </div><!-- end card header -->
                                            ...
                                            <tbody>
                                                @foreach ($months as $month)
                                                    <tr>
                                                        ...
                                                        <td> <input type="hidden" name="week[]" value="{{ $month['week'] }}"> {{ $month['week'] }}</td>
                                                        <td> @isset($month['amount']) Repayment @else Weekly Dues @endisset</td>
                                                        <td> <input type="hidden" name="original[]"  @isset($month['amount']) value="{{ $month['amount'] }}" @else value="{{ $plan->dues  }}" @endisset> @isset($month['amount']) {{ number_format($month['amount'] , 2)}} @else {{ number_format($plan->dues, 2)}} @endisset </td>
                                                    </tr>
                                                @endforeach
                                            </tbody>
                                        </table>
