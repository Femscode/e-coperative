                ...
                <div class="card-body p-4">
                    <div class="text-center">
                        <div class="profile-user position-relative d-inline-block mx-auto  mb-4">
                            <img @if($user->profile_image) src="https://e-coop.cthostel.com/ecoop_files/public/{{ $user->profile_pic }}" @else src="{{ asset('assets/images/avatar.png') }}" @endif data-id="profile" id="userProfileImage" class="rounded-circle avatar-xl img-thumbnail user-profile-image previews" alt="user-profile-image">
