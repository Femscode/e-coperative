                                ...
                                <table class="table align-middle table-row-bordered mb-0 fs-6 gy-5 min-w-300px">
                                    ...
                                    <tbody class="fw-bold text-gray-600">
                                        ...
                                        <tr>
                                            ...
                                            <td class="fw-bolder text-end">Whatsapp
                                            </td>
                                        </tr>
                                        <!--end::Payment method-->
                                        <!--begin::Date-->
                                        <tr>
                                            <td class="text-muted">
                                                <div class="d-flex align-items-center">
                                                    ...
                                                    <!--end::Svg Icon-->Total Amount
                                                </div>
                                            </td>
                                            <td class="fw-bolder text-end"># {{number_format($order->total_price,2)}}
                                            </td>
                                        </tr>
                                        <!--end::Date-->
                                    </tbody>
                                ...
                                <div class="card-body pt-0">
                                    <div class="table-responsive">
                                        ...
                                        <table class="table align-middle table-row-dashed fs-6 gy-5 mb-0">
                                            ...
                                            <tbody class="fw-bold text-gray-600">
                                                <!--begin::Products-->
                                                @foreach($carts['content'] as $product)
                                                <tr>
                                                    <!--begin::Product-->
                                                    <td class='text-end'>
                                                        <a
                                                ...
                                                <tr>
                                                    ...
                                                    <td class="text-dark fs-3 fw-boldest text-end">
                                                        ₦{{number_format($order->total_price + $order->delivery_amount +
                                                        50,2)}}</td>
                                                </tr>
                                                <!--end::Grand total-->
                                            </tbody>
